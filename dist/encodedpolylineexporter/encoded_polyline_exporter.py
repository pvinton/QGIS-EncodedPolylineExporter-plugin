...
class EncodedPolylineExporter:
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate('EncodedPolylineExporter', message)
    ...
    def initGui(self):
        ...
        icon_path = ':/plugins/encoded_polyline_exporter/icon.png'
        self.add_action(
            icon_path,
            text=self.tr(u'Export features to encoded polyline'),
            callback=self.run,
    ...
    def unload(self):
        ...
        for action in self.actions:
            self.iface.removePluginMenu(
                self.tr(u'&Encoded Polyline Exporter'),
                action)
